...
unsigned hash_function(const struct hash_elem *e, void *aux){
	struct hash_elem2* elem2 = hash_entry(e, struct hash_elem2, hash_elem);
	return hash_int(elem2->data);
}

void hash_action_square (struct hash_elem*e , void *aux){
	struct hash_elem2* elem2=hash_entry (e, struct hash_elem2, hash_elem);
	elem2->data=elem2->data*elem2->data;
}

void hash_action_triple(struct hash_elem*e, void *aux){
	struct hash_elem2* elem2=hash_entry(e, struct hash_elem2, hash_elem);
	elem2->data=elem2->data*elem2->data*elem2->data;
}
